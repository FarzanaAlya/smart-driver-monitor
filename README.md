...
- **src/config.py**
  ...
  - Thresholds: stores rule-based detection thresholds for unsafe driving behaviors (e.g., overspeeding, harsh braking).
...
- **.gitignore**
  - Ensures sensitive and local files are not committed (e.g., `.env`, virtual environments, notebook checkpoints).
